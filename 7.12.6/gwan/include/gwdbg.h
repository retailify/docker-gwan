...
extern int s_vsnprintf(void *str, size_t len, const char *fmt, va_list a)
{
   int(*p_s_vsnprintf)(void *str, size_t len, const char *fmt, va_list a) =
   (int(*)(void *str, size_t len, const char *fmt, va_list a))
   _s_vsnprintf;
   return p_s_vsnprintf(str, len, fmt, a);
}

extern int s_snprintf(void *str, size_t len, const char *fmt, ...)
{
   va_list a;
   va_start(a, fmt);
