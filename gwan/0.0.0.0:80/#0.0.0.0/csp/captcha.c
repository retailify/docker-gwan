...
//            
//      Note: The purpose of this script is to illustrate the ultrafast G-WAN 
//            frame-buffer drawing and on-the-fly GIF in-memory I/O abilities.
//            This is not a functional captcha because there's no mechamisn 
//            here either to create, keep or check any secret. This script is
//            merely introducing the idea that GIF transparency can be used to
//            do such a thing.
//
//            The above notice was added because some were vocal about having
//            "broken the G-WAN captcha" which is as ridiculous as claiming
//            to having successfully forced... a lockless door. Congrats to
//            these self-proclaimed 'hackers' for elevating the level of the 
//            discussion with hundreds of duplicated sites publishing this 
//            purposely misleading technical nonsence despite our explanation.
//            It looks like yet another anti-G-WAN FUD (Fear, Uncertainty and
//            Doubt) campaign rather than computer science.
// ============================================================================
...
int main(int argc, char *argv[])
{
   ...
   if(!gif) { free(bmp); return HTTP_503_SERVICE_UNAVAILABLE; }
